package ro.ciacob.math {
    ...
    public class Fraction implements IFraction {
         ...
         */
        private function lcm(a:int, b:int):int {
            return (a / gcf(a, b)) * b;
        }
        ...
        public function Fraction(...params) {
            ...
            if (params.length == 0) {
                ...
                if (params[0] is IFraction) {
                    ...
                    _setValue(tmpFract.numerator, tmpFract.denominator);
                }
        ...
        public function setValue(Numerator:int, Denominator:int):void {
            _setValue(Numerator, Denominator);
        }
        ...
        /**
         * We need to carefully guide JSON serialization, or else an infinite loop might occur.
         * @return An Array containing the numerator and denominator, in this order.
         */
        ...
        /**
         * Delegatee of public function `setValue`, to avoid calling public functions from the constructor.
         *
         * @param Numerator - Fraction numerator to set.
         * @param Denominator - Fraction Denominator to set.
         */
        private function _setValue(Numerator:int, Denominator:int):void {
